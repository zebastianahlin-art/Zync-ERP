        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr>
                    ...
                    <?php if ($invoice['status'] === 'registered'): ?>
                    <td class="px-4 py-3"><form method="POST" action="/finance/invoices-in/<?= $invoice['id'] ?>/lines/<?= $l['id'] ?>/delete"><?= \App\Core\Csrf::field() ?><button class="text-red-500 hover:text-red-700 text-xs">Ta bort</button></form></td>
                    <?php endif; ?>
                </tr>
                <?php endforeach; ?>
                <?php if (empty($lines)): ?>
