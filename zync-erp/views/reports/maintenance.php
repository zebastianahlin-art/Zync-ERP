...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Underhållsrapport</h1>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 text-center"><div class="text-3xl font-bold text-indigo-600 dark:text-indigo-400"><?= (int)($s['total_orders'] ?? 0) ?></div><div class="text-sm text-gray-500 mt-1">Totalt arbetsordrar</div></div>
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 text-center"><div class="text-3xl font-bold text-orange-500"><?= (int)($s['open_orders'] ?? 0) ?></div><div class="text-sm text-gray-500 mt-1">Öppna</div></div>
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 text-center"><div class="text-3xl font-bold text-green-500"><?= (int)($s['closed_orders'] ?? 0) ?></div><div class="text-sm text-gray-500 mt-1">Stängda</div></div>
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 text-center"><div class="text-3xl font-bold text-gray-700 dark:text-gray-300"><?= number_format((float)($s['total_cost'] ?? 0), 0, ',', ' ') ?> kr</div><div class="text-sm text-gray-500 mt-1">Total kostnad</div></div>
    </div>
