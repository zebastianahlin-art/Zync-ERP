<div class="max-w-lg space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Skapa roll</h1>
    </div>
    <form method="post" action="/admin/roles" class="space-y-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        ...
        <div>
            ...
            <input type="text" name="slug" value="<?= htmlspecialchars($old['slug'] ?? '') ?>" placeholder="t.ex. editor" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none">
        ...
        <div>
            ...
            <input type="number" name="level" min="1" max="10" value="<?= (int)($old['level'] ?? 1) ?>" class="w-32 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none">
        </div>
