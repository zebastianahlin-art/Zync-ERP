<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Ny avtalsmall</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
        <form method="POST" action="/purchasing/agreement-templates" class="p-6 space-y-6">
            <?= \App\Core\Csrf::field() ?>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 outline-none"
                          placeholder="Kort beskrivning av mallen..."></textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="default_terms" rows="4"
                          class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 outline-none"
                          placeholder="Ange generella avtalsvillkor..."></textarea>
            </div>
