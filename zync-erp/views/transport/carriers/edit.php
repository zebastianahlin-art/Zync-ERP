<div class="max-w-xl space-y-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Redigera transportör – <?= htmlspecialchars($carrier['name'], ENT_QUOTES, 'UTF-8') ?></h1>

    <form method="POST" action="/transport/carriers/<?= $carrier['id'] ?>" class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
        <?= \App\Core\Csrf::field() ?>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="name" value="<?= htmlspecialchars($carrier['name'], ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div>
                ...
                <input type="text" name="code" value="<?= htmlspecialchars($carrier['code'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
        </div>
        ...
        <div>
            ...
            <select name="type" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <option value="external" <?= $carrier['type'] === 'external' ? 'selected' : '' ?>>Extern</option>
                <option value="internal" <?= $carrier['type'] === 'internal' ? 'selected' : '' ?>>Intern</option>
            </select>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="contact_person" value="<?= htmlspecialchars($carrier['contact_person'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Telefon</label>
                <input type="text" name="phone" value="<?= htmlspecialchars($carrier['phone'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
        </div>
        ...
        <div>
            ...
            <input type="email" name="email" value="<?= htmlspecialchars($carrier['email'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="contract_number" value="<?= htmlspecialchars($carrier['contract_number'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Avtal giltigt t.o.m.</label>
                <input type="date" name="contract_valid_until" value="<?= htmlspecialchars($carrier['contract_valid_until'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
        </div>
        ...
        <div>
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                <input type="checkbox" name="is_active" value="1" <?= $carrier['is_active'] ? 'checked' : '' ?>
        ...
        <div>
            ...
            <textarea name="notes" rows="2" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"><?= htmlspecialchars($carrier['notes'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
        </div>
