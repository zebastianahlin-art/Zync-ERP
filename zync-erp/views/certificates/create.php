<div class="mx-auto max-w-2xl">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Nytt certifikat</h1>
    ...
    <div class="rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-md">
        <form method="POST" action="/certificates" class="space-y-5">
            <?= \App\Core\Csrf::field() ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="issued_date" name="issued_date" type="date" required
                           value="<?= htmlspecialchars($old['issued_date'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div>
                    ...
                    <input id="expiry_date" name="expiry_date" type="date"
                           value="<?= htmlspecialchars($old['expiry_date'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
