            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-gray-700">
                 ...
                 <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                     ...
                     <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                         ...
                         <td class="px-4 py-3">
                             <?php if (($project['project_type'] ?? 'internal') === 'external'): ?>
                                 <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300">Externt</span>
                             <?php else: ?>
                                 <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300">Internt</span>
                             <?php endif; ?>
                         </td>
                     ...
                     <tr><td colspan="7" class="px-4 py-8 text-center text-gray-400">Inga projekt registrerade ännu</td></tr>
                     <?php endif; ?>
                 </tbody>
            </table>
        </div>
