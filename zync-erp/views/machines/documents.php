<div class="max-w-4xl space-y-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            <a href="/machines/<?= $machine['id'] ?>" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700">← Tillbaka</a>
            <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Dokument – <?= htmlspecialchars($machine['name']) ?></h1>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td class="px-6 py-4 text-right text-sm">
                        <form method="post" action="/machines/<?= $machine['id'] ?>/documents/<?= $doc['id'] ?>/delete" class="inline" onsubmit="return confirm('Ta bort?')">
