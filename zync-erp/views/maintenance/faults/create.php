<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Ny felanmälan</h1>
    </div>

    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
        <form method="POST" action="/maintenance/faults" class="space-y-4">
            <?= \App\Core\Csrf::field() ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="fault_type" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm">
                        <option value="mechanical">Mekanisk</option>
                        <option value="electrical">Elektrisk</option>
                        <option value="hydraulic">Hydraulik</option>
                        <option value="pneumatic">Pneumatik</option>
                        <option value="software">Mjukvara</option>
                        <option value="structural">Strukturell</option>
            ...
            <div class="flex justify-end gap-3 pt-2">
                <a href="/maintenance/faults" class="px-4 py-2 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition">Avbryt</a>
                <button type="submit" class="px-4 py-2 text-sm bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition">Skicka felanmälan</button>
            </div>
        </form>
    </div>
</div>
