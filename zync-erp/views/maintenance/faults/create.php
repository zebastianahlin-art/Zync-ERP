<div class="space-y-6">
    ...
    <form method="POST" action="/maintenance/faults" class="space-y-6">
        <?= \App\Core\Csrf::field() ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select id="fault_type" name="fault_type" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                        ...
                        ?>
                        <option value="<?= htmlspecialchars($val, ENT_QUOTES, 'UTF-8') ?>" <?= (($_POST['fault_type'] ?? '') === $val) ? 'selected' : '' ?>>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="/maintenance/faults" class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition">
                Avbryt
            </a>
        </div>
    </form>
