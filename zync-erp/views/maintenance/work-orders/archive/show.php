<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span class="inline-flex px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400"><?= htmlspecialchars($wo['status'], ENT_QUOTES, 'UTF-8') ?></span>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            ...
            <div><span class="text-gray-500 dark:text-gray-400">Avslutad av:</span> <span class="ml-1 text-gray-900 dark:text-white"><?= htmlspecialchars($wo['completed_by_name'] ?? '—', ENT_QUOTES, 'UTF-8') ?></span></div>
