<div class="mx-auto max-w-2xl">
    ...
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Redigera artikel</h1>
    ...
    <div class="rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-md">
        <form method="POST" action="/articles/<?= $article->id ?>" class="space-y-5">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input id="article_number" name="article_number" type="text" required
                           value="<?= htmlspecialchars($article->articleNumber, ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div>
                    ...
                    <input id="purchase_price" name="purchase_price" type="number" step="0.01" min="0"
                           value="<?= htmlspecialchars($article->purchasePrice !== null ? (string) $article->purchasePrice : '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div>
                    ...
                    <input id="selling_price" name="selling_price" type="number" step="0.01" min="0" required
                           value="<?= htmlspecialchars((string) $article->sellingPrice, ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div>
                    ...
                    <select id="vat_rate" name="vat_rate" required
                        ...
                        <?php foreach (['25.00' => '25%', '12.00' => '12%', '6.00' => '6%', '0.00' => '0%'] as $value => $label): ?>
                            <option value="<?= $value ?>"
                                <?= number_format($article->vatRate, 2, '.', '') === $value ? 'selected' : '' ?>>
                                <?= $label ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div>
                    ...
                    <input id="category" name="category" type="text"
                           value="<?= htmlspecialchars($article->category ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    ...
                    <select id="supplier_id" name="supplier_id"
                        ...
                        <?php foreach ($suppliers as $s): ?>
                            <option value="<?= (int) $s['id'] ?>"
                                <?= $article->supplierId === (int) $s['id'] ? 'selected' : '' ?>>
