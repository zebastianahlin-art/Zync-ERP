<div class="max-w-2xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Ny produktionslinje</h1>
    </div>
    <form method="post" action="/production/lines" class="space-y-5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="capacity" value="<?= htmlspecialchars($old['capacity'] ?? '') ?>" placeholder="t.ex. 500 enheter/dag" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none">
            </div>
            <div>
        ...
        <div>
            ...
            <input type="number" name="sort_order" value="<?= (int)($old['sort_order'] ?? 0) ?>" class="w-32 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none">
        </div>
