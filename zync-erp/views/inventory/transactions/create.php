<div class="space-y-6" x-data="{ type: 'receipt' }">
    <!-- Header -->
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Ny lagertransaktion</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 max-w-2xl">
        <form method="POST" action="/inventory/transactions" class="space-y-5">
            <?= \App\Core\Csrf::field() ?>
            ...
            <!-- Till lagerställe (only for transfer) -->
            <div x-show="type === 'transfer'" x-cloak :aria-hidden="type !== 'transfer'">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Till lagerställe</label>
