<div class="mx-auto max-w-2xl">
    ...
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900">New Customer</h1>
        <a href="/customers" class="text-sm text-gray-500 hover:text-indigo-600 transition-colors">&larr; Back</a>
    </div>
    ...
    <div class="rounded-2xl bg-white p-8 shadow-md">
        <form method="POST" action="/customers" class="space-y-5">
            ...
            <div>
                <label for="org_number" class="block text-sm font-medium text-gray-700">Organisation Number <span class="text-red-500">*</span></label>
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="3"
                          class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"><?= htmlspecialchars($old['address'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
            </div>

            <div class="flex items-center justify-end space-x-3 pt-2">
                <a href="/customers" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">Cancel</a>
                <button type="submit"
