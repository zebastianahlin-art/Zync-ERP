...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            ...
            <div><span class="text-gray-500 dark:text-gray-400">Kategori:</span> <span class="ml-1 text-gray-900 dark:text-white"><?= htmlspecialchars($equipment['category'], ENT_QUOTES, 'UTF-8') ?></span></div>
            ...
            <div><span class="text-gray-500 dark:text-gray-400">Byggnad:</span> <span class="ml-1 text-gray-900 dark:text-white"><?= htmlspecialchars($equipment['building'] ?? '—', ENT_QUOTES, 'UTF-8') ?></span></div>
            ...
            <div><span class="text-gray-500 dark:text-gray-400">Tillverkningsår:</span> <span class="ml-1 text-gray-900 dark:text-white"><?= htmlspecialchars($equipment['year_of_manufacture'] ?? '—', ENT_QUOTES, 'UTF-8') ?></span></div>
            <div><span class="text-gray-500 dark:text-gray-400">Installerat:</span> <span class="ml-1 text-gray-900 dark:text-white"><?= htmlspecialchars($equipment['installed_date'] ?? '—', ENT_QUOTES, 'UTF-8') ?></span></div>
            <div><span class="text-gray-500 dark:text-gray-400">Garanti till:</span> <span class="ml-1 text-gray-900 dark:text-white"><?= htmlspecialchars($equipment['warranty_until'] ?? '—', ENT_QUOTES, 'UTF-8') ?></span></div>
        </div>
