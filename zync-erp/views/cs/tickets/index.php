...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Alla ärenden</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
            <input type="text" id="search" placeholder="Sök ärenden…"
                class="w-full max-w-xs border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                onkeyup="filterTable(this.value)">
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm" id="ticketTable">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-gray-500 dark:text-gray-400 uppercase text-xs tracking-wide">Tilldelad</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td class="px-4 py-3 text-gray-600 dark:text-gray-400"><?= htmlspecialchars($t['assigned_name'] ?? '—', ENT_QUOTES, 'UTF-8') ?></td>
                        ...
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            ...
                            <a href="/cs/tickets/<?= $t['id'] ?>/edit" class="text-xs text-indigo-600 dark:text-indigo-400 hover:underline mr-2">Redigera</a>
                            <form method="POST" action="/cs/tickets/<?= $t['id'] ?>/delete" class="inline" onsubmit="return confirm('Ta bort ärendet?')">
                                <?= \App\Core\Csrf::field() ?>
                    ...
                    <tr><td colspan="9" class="px-4 py-8 text-center text-gray-400 dark:text-gray-500">Inga ärenden registrerade ännu</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
